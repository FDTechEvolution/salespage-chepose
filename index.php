...
<html lang="en">
    ...
    <head>
        <!-- Title -->
        <title>แผ่นเช็ดฝ้า CHE POS'E</title>
        ...
        <link rel="stylesheet" href="https://assets.wesales.online/vendor/fancybox/jquery.fancybox.min.css">
        <link rel="stylesheet" href="https://assets.wesales.online/vendor/typedjs/typed.css">
        <link rel="stylesheet" href="https://assets.wesales.online/vendor/animate.css">
        <link rel="stylesheet" href="https://assets.wesales.online/vendor/hs-megamenu/src/hs.megamenu.css">
        <link rel="stylesheet" href="https://assets.wesales.online/vendor/hamburgers/hamburgers.min.css">

        <!-- CSS Unify -->
        <link rel="stylesheet" href="https://assets.wesales.online/css/unify-core.css">
    ...
    <body>
        <main>
            ...
            <section class="g-flex-centered g-bg-pos-center g-bg-img-hero g-pos-rel g-z-index-1 g-overflow-hidden" style="background-image: url(https://assets.wesales.online/assets/img-temp/1920x1080/img14.jpg);" data-calc-target="#js-header">
                ...
                <div class="g-pos-abs g-bottom-0 g-right-0" data-animation="fadeInUp" data-animation-delay="1800" data-animation-duration="1500">
                    <img class="img-fluid" src="https://assets.wesales.online/img-temp/1920x1080/img16.png" alt="Image Description">
                </div>
                ...
                <div class="container text-center g-z-index-1">
                    ...
                    <div class="mb-4">
                        <h1 class="h2 d-inline-block g-color-black g-font-weight-700 g-font-size-40 g-font-size-75--md text-uppercase g-line-height-1" data-animation="fadeInDown" data-animation-delay="1000" data-animation-duration="1500">แผ่นเช็ดฝ้า</h1>
                        <h2 class="h2 d-inline-block g-color-black g-font-weight-700 g-font-size-40 g-font-size-75--md text-uppercase g-line-height-1" data-animation="fadeInDown" data-animation-delay="1200" data-animation-duration="1500">Che</h2>
                        <h2 class="h2 d-inline-block g-color-primary g-font-weight-700 g-font-size-40 g-font-size-75--md text-uppercase g-line-height-1" data-animation="fadeInDown" data-animation-delay="1400" data-animation-duration="1500">Pos'e</h2>
                    </div>
                    ...
                    <div class="mx-auto g-max-width-600 g-overflow-hidden">
                        <p class="g-color-black g-font-size-18 g-font-size-24--md g-mb-40" data-animation="fadeInDown" data-animation-delay="1600" data-animation-duration="1500">
                            แผ่นลำสีเช็ดฝ้า ช่วย ลดฝ้า กระ จุดด่างดำ เป็นนวัตกรรมใหม่ในการดูแลผิวหน้า
                        </p>
                    </div>

                    <div data-animation="fadeInDown" data-animation-delay="2000" data-animation-duration="1500">
                        <a class="btn btn-lg u-btn-outline-black g-font-weight-600 g-font-size-13 text-uppercase g-rounded-50 mx-2 g-px-25 g-py-15" href="#">รายละเอียดสินค้า</a>
                        <a class="btn btn-lg u-btn-primary g-font-weight-600 g-font-size-13 text-uppercase g-rounded-50 mx-2 g-px-25 g-py-15" href="#">สั่งซื้อตอนนี้</a>
                    </div>
                </div>
            </section>
            <!-- End Promo Block -->
            ...
            <section class="text-center">
                <div class="row no-gutters">
                    <!-- Icon Blocks -->
                    <div class="col-lg-4 u-bg-overlay g-bg-img-hero g-bg-cyan-opacity-0_9--after g-color-white text-center g-pa-60" style="background-image: url(assets/img-temp/400x270/img6.jpg);">
                    ...
                    <!-- Icon Blocks -->
                    <div class="col-lg-4 u-bg-overlay g-bg-img-hero g-bg-purple-opacity-0_9--after g-color-white text-center g-pa-60" style="background-image: url(assets/img-temp/400x270/img15.jpg);">
                        <div class="u-bg-overlay__inner">
                            <span class="u-icon-v2 u-icon-size--lg u-shadow-v24 rounded-circle g-mb-25">
                    ...
                    <!-- Icon Blocks -->
                    <div class="col-lg-4 u-bg-overlay g-bg-img-hero g-bg-teal-opacity-0_9--after g-color-white text-center g-pa-60" style="background-image: url(assets/img-temp/400x270/img7.jpg);">
                        <div class="u-bg-overlay__inner">
                            <span class="u-icon-v2 u-icon-size--lg u-shadow-v24 rounded-circle g-mb-25">
                    ...
                    <article class="row">
                        ...
                        <div class="col-lg-6 g-mb-30">
                            ...
                            <div class="g-pl-90--sm">
                                ...
                                <div class="d-flex">
                                    <!-- Video Bock -->
                                    <div class="u-shadow-v21 g-bg-img-hero g-pos-rel g-height-160 g-width-300 rounded" data-bg-img-src="assets/img-temp/400x270/img1.jpg" style="background-image: url('assets/img-temp/400x270/img1.jpg');">
                                        <a class="js-fancybox-media g-absolute-centered" href="javascript:;" data-src="//vimeo.com/167434033" data-speed="1000" data-animate-in="flipInX" data-animate-out="flipOutX">
            ...
            <section class="dzsparallaxer auto-init height-is-based-on-content use-loading mode-scroll">
                <!-- Parallax Image -->
                <div class="divimage dzsparallaxer--target w-100 u-bg-overlay g-bg-repeat g-bg-white-gradient-opacity-v1--after" style="height: 160%; background-image: url(assets/img/bg/pattern3.png);"></div>
                <!-- End Parallax Image -->
                ...
                <div class="container u-bg-overlay__inner g-color-white g-py-100">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 g-mb-60">
                            <div class="media">
                                <div class="g-height-140 g-width-140 g-mr-30">
                                    <div class="js-pie-rtl u-chart-pie-v1 g-brd-purple g-height-140 g-width-140" data-circles-value="53" data-circles-max-value="200" data-circles-bg-color="#111" data-circles-fg-color="#9a69cb" data-circles-radius="70" data-circles-stroke-width="2" data-circles-font-size="35"
                        ...
                        <div class="col-lg-6 g-mb-60">
                            <div class="media">
                                <div class="g-height-140 g-width-140 g-mr-30">
                                    <div class="js-pie-rtl u-chart-pie-v1 g-brd-pink g-height-140 g-width-140" data-circles-value="96" data-circles-max-value="200" data-circles-bg-color="#111" data-circles-fg-color="#e81c62" data-circles-radius="70" data-circles-stroke-width="2" data-circles-font-size="35"
                                         data-circles-duration="2000" data-circles-scroll-animate="true">
                                    </div>
                                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 g-mb-60 g-mb-0--lg">
                            <div class="media">
                                <div class="g-height-140 g-width-140 g-mr-30">
                                    <div class="js-pie-rtl u-chart-pie-v1 g-brd-cyan g-height-140 g-width-140" data-circles-value="8" data-circles-max-value="15" data-circles-bg-color="#111" data-circles-fg-color="#00bed6" data-circles-radius="70" data-circles-stroke-width="2" data-circles-font-size="35"
                        ...
                        <div class="col-lg-6">
                            <div class="media">
                                <div class="g-height-140 g-width-140 g-mr-30">
                                    <div class="js-pie-rtl u-chart-pie-v1 g-brd-primary g-height-140 g-width-140" data-circles-value="48" data-circles-max-value="200" data-circles-bg-color="#111" data-circles-fg-color="#72c02c" data-circles-radius="70" data-circles-stroke-width="2" data-circles-font-size="35"
                                         data-circles-duration="2000" data-circles-scroll-animate="true">
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4 g-mb-30">
                            ...
                            <div class="g-brd-around g-brd-blue rounded g-pa-40">
                                ...
                                <div class="d-flex justify-content-center">
                                    <img class="align-self-center g-width-40 g-height-40 rounded-circle mr-3" src="assets/img-temp/100x100/img7.jpg" alt="Image Description">
                                    <div>
        ...
        <script src="https://assets.wesales.online/vendor/hs-megamenu/src/hs.megamenu.js"></script>
        ...
        <script src="https://assets.wesales.online/vendor/fancybox/jquery.fancybox.min.js"></script>
        <script src="https://assets.wesales.online/vendor/typedjs/typed.min.js"></script>
        <script src="https://assets.wesales.online/vendor/circles/circles.min.js"></script>
        ...
        <script src="https://assets.wesales.online/js/components/hs.tabs.js"></script>
        <script src="https://assets.wesales.online/js/components/hs.popup.js"></script>
        <script src="https://assets.wesales.online/js/components/text-animation/hs.text-slideshow.js"></script>
        <script src="https://assets.wesales.online/js/components/hs.rating.js"></script>
        <script src="https://assets.wesales.online/js/components/hs.onscroll-animation.js"></script>
        <script src="https://assets.wesales.online/js/components/hs.counter.js"></script>
        <script src="https://assets.wesales.online/js/components/hs.chart-pie.js"></script>
